...
class Motor:
    ...
    def frear(self):
        self.velocidade -= 2
        self.velocidade = max(0, self.velocidade)       #Se houver um valor negativo o '0' é maior do que o valor, portatanto irá retornar o '0', caso o valor seja positivo, ele retorna o valor positivo da velocidade
