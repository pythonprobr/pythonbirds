...
class Fase():
    ...
    def adicionar_porco(self, *porcos):
        ...
        print(f"TYPE PORCOS ====== {type(porcos)}")
        print(f"TYPE PORCOS self ====== {type(self._porcos)}")
        return self._porcos
