...
if __name__ == '__main__':
    renzo = Pessoa(nome='Renzo') # o nome renzo é do tipo pessoa (tipo = int, float, e aqui pessoa)
    luciano = Pessoa(renzo, nome='Luciano') # aqui colocamos renzo como parametro ligado ao parâmetro filhos acima descrito e atributo de luciano.
